    ...
    <section className="pv2-hero" aria-labelledby="pv2-hero-title">
      <div className="pv2-frame pv2-hero__grid">
        ...
        <div className="pv2-hero__copy">
          <h1 id="pv2-hero-title" className="pv2-hero-enter pv2-hero-enter--1">
            {HERO.headline}
          </h1>
          <p className="pv2-hero__support pv2-hero-enter pv2-hero-enter--2">{HERO.support}</p>
          <div className="pv2-hero__action pv2-hero-enter pv2-hero-enter--3">
            <PrimaryCallLinkV2 />
          </div>
        </div>
